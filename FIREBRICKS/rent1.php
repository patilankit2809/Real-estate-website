      ...
      echo"<section id='agents'>
            <center><div class='container'>
              <h2>Property</h2>
                  ...
                  <div class='flex'>  
                    <div class='card'>
        <center> <img id='posts-img=' src='$image' alt:'' class='slider-image' style='width:52%;'>
            ...
            <div class='shop-item-details'>
                      <span class='price' style='color:black;font-size:1.5rem;font-weight:600;'>$title </span>
                        <span class='bed' style='color:black;font-size:1rem;font-weight:600;'>
                        price = $content|
                        </span>
                        <span class='sqft' style='color:black;font-size:1rem;font-weight:600;'>content = $user|</span>
    ...
    ?><footer>
        <div class="flex container">
            ...
            <div class="footer-about">
                ...
                <p style="color: orange;">Property Sahi. Milegi Yahin.India's No. 1 Property Site is now a Superbrand</p>
            </div>
            ...
            <div class="footer-subscribe" id="address-container">
                <label style="color: white;">Address</label>
                    ...
                    <h5 style="color: orange;">232-232-2323</h5>

                    <label style="color: white;">Email Address</label>
                    <h5 style="color: orange;">ouremail@domain.com</h5>

                <label style="color: white;" class="follow-us">Follow Us</label> 
